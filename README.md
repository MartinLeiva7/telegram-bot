...
Este bot de TEST está hosteado en **Oracle Cloud (Always Free)** utilizando una instancia de Ubuntu 24.04.

El flujo de despliegue está automatizado mediante **GitHub Actions**:
* **CI/CD:** Cada `push` a la rama `develop` dispara un workflow que actualiza el código en el servidor.
